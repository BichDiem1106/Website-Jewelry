...
<head>
  ...
  <title>Đơn Hàng Của Tôi – LUMIÈRE</title>
...
<body class="bg-cream">
    ...
    <footer class="pt-5 pb-3 border-top mt-5" style="background-color: #fdfbf7;">
        <div class="container text-center">
            <h4 class="fw-bold gold-text mb-3" style="font-family: 'Times New Roman', serif; letter-spacing: 2px;">LUMIÈRE</h4>
            <p class="small text-muted">&copy; 2026 LUMIÈRE. Bản quyền thuộc về Nhóm 6.</p>
        </div>
    </footer>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            if (badge) {
                const count = localStorage.getItem("LUMIÈRE_cart") ? JSON.parse(localStorage.getItem("LUMIÈRE_cart")).reduce((s, i) => s + i.quantity, 0) : 0;
