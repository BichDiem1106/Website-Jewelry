...
class AdminController
{
    ...
    public function exportSales()
    {
        try {
            ...
            header('Content-Disposition: attachment; filename="LUMIÈRE_bao_cao_doanh_thu_' . date('Ymd_His') . '.csv"');
    ...
    public function exportInventory()
    {
        try {
            ...
            header('Content-Type: text/csv; charset=utf-8');
            header('Content-Disposition: attachment; filename="LUMIÈRE_bao_cao_ton_kho_' . date('Ymd_His') . '.csv"');
