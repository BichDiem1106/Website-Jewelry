...
(1, 'Quản Trị Viên', 'admin@LUMIÈRE.local', '0901234567', '$2y$10$D9arBnnCCmcCb1oj6dNkgOXtipipRyas1XUmTqSpbCupBGvRuJsEO', 'admin', 'active'),
...
('Bông Tai Cao Cấp', 'Bộ sưu tập khuyên tai, bông tai LUMIÈRE sang trọng', 'show');
...
(4, 'Bông tai nút thắt vô cực may mắn LUMIÈRE', 'Biểu tượng của sự vô tận về tài lộc và tình yêu trường tồn mãi theo thời gian.', 300000, 0, 125, 'assets/images/product/image_2076968380_28.jpg', 'show'),
...
('LUMIÈRE20', 'percent', 20, 100000, 300000, 50, 0, '2026-01-01 00:00:00', '2026-12-31 23:59:59', 'active'),
...
('Nhẫn cưới LUMIÈRE', 'assets/images/banner/banner-3.jpg', '/products?category=1', 3, 'show'),
...
('Trang sức LUMIÈRE có đảm bảo chất lượng không?', 'LUMIÈRE cam kết tất cả sản phẩm đều được làm từ chất liệu cao cấp, có chứng nhận kiểm định và bảo hành chính hãng 12 tháng.', 1, 'show'),
...
('LUMIÈRE có giao hàng toàn quốc không?', 'LUMIÈRE giao hàng toàn quốc với đơn vị vận chuyển uy tín. Phí ship sẽ được tính dựa trên khoảng cách và trọng lượng đơn hàng.', 3, 'show'),
